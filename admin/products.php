        ...
        foreach ($items as $p): ?>
                    <tr class="hover:bg-slate-50 dark:hover:bg-white/5">
                        ...
                        <td class="px-4 py-3 text-right space-x-1">
                            ...
                            <a href="<?php echo url('/admin/products?action=delete&id=' . $p['id'] . '&token=' . csrf_token()); ?>" onclick="return confirmDelete()" class="px-2 py-1 text-xs text-red-500 hover:bg-red-50 rounded-lg">Delete</a>
                        </td>
                    </tr>
                <?php
        endforeach;
