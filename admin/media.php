        ...
        <div class="bg-white/60 dark:bg-white/5 backdrop-blur-xl border border-black/5 dark:border-white/10 rounded-xl overflow-hidden group">
            <div class="aspect-square relative">
                ...
                <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo url('/admin/media?action=delete&id=' . $f['id'] . '&token=' . csrf_token()); ?>" onclick="return confirmDelete()" class="p-2 bg-red-500/20 rounded-lg text-white hover:bg-red-500/40" title="Delete">
